...
public class Transformation extends ListVData {
    ...
    private final ObjectVData objectVData;

    private final Predicate inPredicate;
    private final Predicate outPredicate;

    private transient EngineEvaluator inEngineEvaluator;
    private transient final EngineEvaluator outEngineEvaluator;
    ...
    public void setInEngineEvaluator(EngineEvaluator engineEvaluator) {
        this.inEngineEvaluator = engineEvaluator;
    }
