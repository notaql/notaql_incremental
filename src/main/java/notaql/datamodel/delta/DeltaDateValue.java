...
public class DeltaDateValue extends DateValue implements DeltaValue {
	// Class variables
	...
	public DeltaDateValue(Date value, DeltaMode mode) {
		super(value);
		this.mode = mode;
	}
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(this.getClass() == o.getClass() || o.getClass() == DateValue.class)) return false;
    ...
    /* (non-Javadoc)
     * @see notaql.datamodel.DateValue#deepCopy()
     */
    @Override
    public Value deepCopy() {
        return new DeltaDateValue(this.getValue(), this.getMode());
    }
	...
	public Value getRawValue() {
		return new DateValue(this.getValue());
	}
}
