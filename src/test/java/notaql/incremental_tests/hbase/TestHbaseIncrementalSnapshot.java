...
/**
 * Collection of tests for testing the incremental capabilities of NotaQl with HBase using snapshots.
 */
public class TestHbaseIncrementalSnapshot extends TestHbase {
	// Configuration
	private static final String TABLE_SNAPSHOT_ID = TEST_PREFIX + "snapshot";
	
	
	// Object variables
	private static HTable snapshot;
	...
	private static void createSnapshot() throws IOException, InterruptedException {
		logStatic(TestHbaseIncrementalSnapshot.class, "createSnapshot()", Loglevel.DEBUG);
	...
	/**
	 * Tests the connection to HBase and the Snapshots.
	 * 
	 * @throws Exception
	 */
	@Test
