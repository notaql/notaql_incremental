...
/**
 * Collection of tests for testing the incremental capabilities of NotaQl with MongoDB using snapshots.
 */
public class TestMongodbIncrementalSnapshot extends TestMongodb {
	// Configuration
	...
	private static void createSnapshot() throws IOException, InterruptedException {
		logStatic(TestMongodbIncrementalSnapshot.class, "createSnapshot()", Loglevel.DEBUG);
	...
	/**
	 * Tests the connection to MongoDB and the Snapshots.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	public void test003() throws Exception {
		...
		// Prepare the 1. execution
		final String query = "OUT._id <- IN.employer, OUT.sum <- SUM(IN.salary+IN.bonus), OUT.count <- COUNT(IN._id)";
	...
	public void test004() throws Exception {
		...
		// Prepare the 1. execution
		final String query = "OUT._id <- IN.employer, OUT.sum <- SUM(IN.salary), OUT.count <- COUNT(IN._id)";
		put(input, "A", "employer", "Employer1");
		put(input, "A", "salary", 10000);
	...
	public void test006() throws Exception {
		...
		// Prepare the 1. execution
		final String query = "IN-FILTER: IN.salary > 5000, OUT._id <- 'result', OUT.sum <- SUM(IN.salary), OUT.count <- COUNT(IN._id)";
		put(input, "A", "salary", 10000);
		put(input, "B", "salary", 20000);
	...
	public void test007() throws Exception {
		...
		// Prepare the 1. execution
		final String query = "IN-FILTER: IN.salary > 11000, OUT._id <- 'result', OUT.sum <- SUM(IN.salary), OUT.count <- COUNT(IN._id)";
		put(input, "A", "salary", 10000);
		put(input, "B", "salary", 20000);
	...
	public void test008() throws Exception {
		...
		// Prepare the 1. execution
		final String query = "IN-FILTER: IN.salary < 25000, OUT._id <- 'result', OUT.sum <- SUM(IN.salary), OUT.count <- COUNT(IN._id)";
		put(input, "A", "salary", 10000);
		put(input, "B", "salary", 20000);
	...
	public void test009() throws Exception {
		...
		// Prepare the 1. execution
		final String query = "IN-FILTER: IN.salary > 16000, OUT._id <- 'result', OUT.sum <- SUM(IN.salary), OUT.count <- COUNT(IN._id)";
		put(input, "A", "salary", 10000);
		put(input, "B", "salary", 20000);
	...
	public void test010() throws Exception {
		...
		// Prepare the 1. execution
		final String query = "IN-FILTER: IN.salary > 11000, OUT._id <- 'result', OUT.sum_salary <- SUM(IN.salary), OUT.sum_coworkers <- SUM(IN.coworkers), OUT.count <- COUNT(IN._id)";
		put(input, "A", "salary", 10000);
	...
	public void test011() throws Exception {
		...
		// Prepare the 1. execution
		final String query = "IN-FILTER: IN.salary < 25000, OUT._id <- 'result', OUT.sum_salary <- SUM(IN.salary), OUT.sum_coworkers <- SUM(IN.coworkers), OUT.count <- COUNT(IN._id)";
		put(input, "A", "salary", 10000);
		put(input, "A", "coworkers", 1);
	...
	public void test012() throws Exception {
		...
		// Prepare the 1. execution
		final String query = "IN-FILTER: IN.salary > 11000, OUT._id <- IN.employer, OUT.sum <- SUM(IN.salary), OUT.count <- COUNT(IN._id)";
		put(input, "A", "employer", "Employer1");
		put(input, "A", "salary", 10000);
	...
	public void test013() throws Exception {
		...
		// Prepare the 1. execution
		final String query = "IN-FILTER: IN.salary < 30000, OUT._id <- IN.employer, OUT.sum <- SUM(IN.salary), OUT.count <- COUNT(IN._id)";
		put(input, "A", "employer", "Employer1");
		put(input, "A", "salary", 10000);
	...
	public void test016() throws Exception {
	   ...
	   // Prepare the 1. execution
	   final String query = "OUT._id <- IN._id, OUT.sum <- SUM(IN.*), OUT.count <- COUNT(IN.*)";
	...
	public void test019() throws Exception {
	   ...
	   // Prepare the 1. execution
	   final String query = "OUT._id <- IN.*.name(), OUT.$(IN._id) <- IN.@";
	   put(input, "A", "salary", 10000);
