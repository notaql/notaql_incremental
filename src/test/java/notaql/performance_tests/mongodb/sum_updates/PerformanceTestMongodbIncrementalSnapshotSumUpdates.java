 ...
 */
public class PerformanceTestMongodbIncrementalSnapshotSumUpdates extends PerformanceTestMongodbIncrementalSnapshot {
	/* (non-Javadoc)
	...
	public static void main(String[] args) throws Exception {
		(new PerformanceTestMongodbIncrementalSnapshotSumUpdates()).execute();
	}
}
