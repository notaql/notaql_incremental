 ...
 */
public class PerformanceTestMongodbIncrementalSnapshotSumInserts extends PerformanceTestMongodbIncrementalSnapshot {
	/* (non-Javadoc)
	...
	public static void main(String[] args) throws Exception {
		(new PerformanceTestMongodbIncrementalSnapshotSumInserts()).execute();
	}
}
