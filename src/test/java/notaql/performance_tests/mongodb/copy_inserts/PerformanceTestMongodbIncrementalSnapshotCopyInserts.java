 ...
 */
public class PerformanceTestMongodbIncrementalSnapshotCopyInserts extends PerformanceTestMongodbIncrementalSnapshot {
	/* (non-Javadoc)
	...
	public static void main(String[] args) throws Exception {
		(new PerformanceTestMongodbIncrementalSnapshotCopyInserts()).execute();
	}
}
