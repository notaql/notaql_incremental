 ...
 */
public class PerformanceTestMongodbIncrementalTimestampCopyInserts extends PerformanceTestMongodbIncrementalTimestamp {
	/* (non-Javadoc)
	...
	public static void main(String[] args) throws Exception {
		(new PerformanceTestMongodbIncrementalTimestampCopyInserts()).execute();
	}
}
