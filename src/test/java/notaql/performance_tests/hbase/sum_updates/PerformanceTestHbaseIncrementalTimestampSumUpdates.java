 ...
 */
public class PerformanceTestHbaseIncrementalTimestampSumUpdates extends PerformanceTestHbaseIncrementalTimestamp {
	/* (non-Javadoc)
	...
	public static void main(String[] args) throws Exception {
		(new PerformanceTestHbaseIncrementalTimestampSumUpdates()).execute();
	}
}
