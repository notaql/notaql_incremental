 ...
 */
public class PerformanceTestHbaseIncrementalTriggerCopyUpdates extends PerformanceTestHbaseIncrementalTrigger {
	/* (non-Javadoc)
	...
	public static void main(String[] args) throws Exception {
		(new PerformanceTestHbaseIncrementalTriggerCopyUpdates()).execute();
	}
}
