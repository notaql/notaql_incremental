 ...
 */
public class PerformanceTestHbaseIncrementalTimestampCopyUpdates extends PerformanceTestHbaseIncrementalTimestamp {
	/* (non-Javadoc)
	...
	public static void main(String[] args) throws Exception {
		(new PerformanceTestHbaseIncrementalTimestampCopyUpdates()).execute();
	}
}
