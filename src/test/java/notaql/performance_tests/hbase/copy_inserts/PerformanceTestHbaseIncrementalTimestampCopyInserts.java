 ...
 */
public class PerformanceTestHbaseIncrementalTimestampCopyInserts extends PerformanceTestHbaseIncrementalTimestamp {
	/* (non-Javadoc)
	...
	public static void main(String[] args) throws Exception {
		(new PerformanceTestHbaseIncrementalTimestampCopyInserts()).execute();
	}
}
